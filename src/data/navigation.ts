...
export const navigationItems: NavigationItem[] = [
  ...
  { id: "laboratory", label: "Laboratory", icon: FlaskConical, route: "/laboratory", group: "Diagnostics", allowedRoles: ["Super Admin", "Hospital Admin", "Doctor", "Lab Technician"], status: "planned" },
  { id: "radiology", label: "Radiology", icon: ScanSearch, route: "/radiology", group: "Diagnostics", allowedRoles: ["Super Admin", "Hospital Admin", "Doctor", "Radiologist"], status: "planned" },
  { id: "pharmacy", label: "Pharmacy", icon: Pill, route: "/pharmacy", group: "Operations", allowedRoles: ["Super Admin", "Hospital Admin", "Pharmacist", "Doctor"], status: "planned" },
  { id: "ot", label: "OT", icon: Syringe, route: "/ot", group: "Clinical", allowedRoles: ["Super Admin", "Hospital Admin", "Doctor", "Nurse"], status: "planned" },
  { id: "billing", label: "Billing & Finance", icon: CreditCard, route: "/billing", group: "Finance", allowedRoles: ["Super Admin", "Hospital Admin", "Billing Executive", "Management"], status: "planned" },
  { id: "insurance", label: "Insurance & TPA", icon: Landmark, route: "/insurance", group: "Finance", allowedRoles: ["Super Admin", "Hospital Admin", "Billing Executive", "Management"], status: "planned" },
  { id: "inventory", label: "Inventory & Store", icon: Store, route: "/inventory", group: "Operations", allowedRoles: ["Super Admin", "Hospital Admin", "Pharmacist"], status: "planned" },
  { id: "hrms", label: "HRMS", icon: Users, route: "/hrms", group: "Administration", allowedRoles: ["Super Admin", "Hospital Admin", "HR Manager"], status: "planned" },
  { id: "administration", label: "Administration", icon: Building2, route: "/administration", group: "Administration", allowedRoles: ["Super Admin", "Hospital Admin", "Management"], status: "planned" },
  { id: "reports", label: "Reports & Analytics", icon: BarChart3, route: "/reports", group: "Insights", allowedRoles: ["Super Admin", "Hospital Admin", "Management"], status: "planned" },
  { id: "communication", label: "Communication", icon: MessageSquareText, route: "/communication", group: "Platform", allowedRoles: ["Super Admin", "Hospital Admin"], status: "planned" },
  { id: "integrations", label: "Integrations", icon: Workflow, route: "/integrations", group: "Platform", allowedRoles: ["Super Admin", "Hospital Admin"], status: "planned" },
  { id: "security", label: "Security & Compliance", icon: ShieldCheck, route: "/security-compliance", group: "Platform", allowedRoles: ["Super Admin", "Hospital Admin"], status: "planned" },
  { id: "mobile", label: "Mobile & Remote", icon: RadioTower, route: "/mobile", group: "Platform", allowedRoles: allRoles, status: "planned" },
  { id: "ai", label: "AI & Smart Healthcare", icon: Bot, route: "/smart-healthcare", group: "Platform", allowedRoles: ["Super Admin", "Hospital Admin", "Doctor", "Radiologist", "Management"], status: "planned" },
